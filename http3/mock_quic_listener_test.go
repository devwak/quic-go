...
// Source: github.com/devwak/quic-go/http3 (interfaces: QUICListener)
//
// Generated by this command:
//
//	mockgen -typed -package http3 -destination mock_quic_listener_test.go github.com/devwak/quic-go/http3 QUICListener
//
