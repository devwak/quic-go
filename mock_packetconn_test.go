...
//
//	mockgen -typed -package quic -self_package github.com/devwak/quic-go -self_package github.com/devwak/quic-go -destination mock_packetconn_test.go net PacketConn
//
